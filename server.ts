...
async function ensureDatabaseSchema(poolInstance: any) {
  try {
    console.log('Verifying or creating database tables on server startup...');
    ...
    `);
    console.log('All database tables verified and created successfully on startup!');
  } catch (err) {
    console.error('Error ensuring database tables exist on server startup:', err);
  }
}
...
async function startServer() {
  ...
  // Run database table verification
